...
ok( my $study = Bio::HPS::FastTrack::VRTrackWrapper::Study->new(study => 'Comparative RNA-seq analysis of three bacterial species' , database => 'pathogen_hpsft_test'), 'Study object creation' );
...
ok( my $study2 = Bio::HPS::FastTrack::VRTrackWrapper::Study->new(study => 'Comparative RNA-seq analysis of three' , database => 'pathogen_hpsft_test', mode => 'prod'), 'Study object creation' );
...
ok( my $study3 = Bio::HPS::FastTrack::VRTrackWrapper::Study->new(study => 'Glabolabo' , database => 'pathogen_hpsft_test', mode => 'prod'), 'Study object creation' );
