...
is ( $snps_runner->command_to_run, '/software/pathogen/internal/pathdev/vr-codebase/scripts/run-pipeline -c ' . $snps_runner->temp_dir . '/fast_track_snps_pipeline.conf -l t/data/log/fast_track_snps_pipeline.log -v -v -L t/data/conf/fast_track/.pathogen_hpsft_test.snps_pipeline.lock -m 500', 'Building run command');
...
is ( $snps_runner2->command_to_run, '/software/pathogen/internal/pathdev/vr-codebase/scripts/run-pipeline -c ' . $snps_runner2->temp_dir . '/fast_track_snps_pipeline.conf -l t/data/log/fast_track_snps_pipeline.log -v -v -L t/data/conf/fast_track/.pathogen_hpsft_test.snps_pipeline.lock -m 500', 'Building run command');
